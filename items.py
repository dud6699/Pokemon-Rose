...
class Item:
    def __init__(self,name):
        ...
        if len(self.desc) != 0 and len(self.desc[0]) > 20:
            self.desc = poke_func.split_text(self.desc[0],20,9)
    ...
    def mod(self) -> float:
        ...
        if self.name == 'TM32 Double Team':
            return ['Reverse','Caterpie','Metapod','Weedle','Kakuna','Magikarp','Ditto','Unown','Wobbuffet','Smeargle','Wurmple','Silcoon','Cascoon','Wynaut','Beldum','Kricketot','Combee','Tynamo','Scatterbug','Spewpa','Tapu Bulu','Cosmog','Cosmoem','Poipole','Stakataka']
        if self.name == 'TM37 Sandstorm':
            return ['Icy_Gigalith','Sandshrew','Sandslash','Nidoqueen','Nidoking','Diglett','Alolan_Diglett','Dugtrio','Alolan_Dugtrio','Geodude','Alolan_Geodude','Graveler','Alolan_Graveler','Golem','Alolan_Golem','Onix','Cubone','Marowak','Alolan_Marowak','Lickitung','Rhyhorn','Rhydon','Chansey','Kangaskhan','Tauros','Gyarados','Omanyte','Omastar','Kabuto','Kabutops','Aerodactyl','Snorlax','Articuno','Zapdos','Moltres','Dragonite','Mew','Mewtwo','Sudowoodo','Wooper','Quagsire','Pineco','Forretress','Gligar','Steelix','Scizor','Shuckle','Magcargo','Swinub','Piloswine','Corsola','Skarmory','Phanpy','Donphan','Hitmontop','Miltank','Blissey','Raikou','Entei','Suicune','Larvitar','Pupitar','Tyranitar','Lugia','Ho-Oh','Celebi','Nincada','Ninjask','Shedinja','Nosepass','Mawile','Aron','Lairon','Aggron','Numel','Camerupt','Trapinch','Vibrava','Flygon','Cacnea','Cacturne','Lunatone','Solrock','Barboach','Whiscash','Baltoy','Claydol','Lileep','Cradily','Anorith','Armaldo','Castform','Absol','Relicanth','Metang','Metagross','Regirock','Registeel','Latias','Latios','Groudon','Rayquaza','Jirachi','Torterra','Cranidos','Rampardos','Shieldon','Bastiodon','Gastrodon','Bronzor','Bronzong','Bonsly','Gible','Gabite','Garchomp','Munchlax','Hippopotas','Hippowdon','Lickilicky','Rhyperior','Gliscor','Mamoswine','Probopass','Uxie','Mesprit','Azelf','Dialga','Palkia','Arceus','Roggenrola','Boldore','Gigalith','Drilbur','Excadrill','Sandile','Krokorok','Krookodile','Dwebble','Crustle','Tirtouga','Carracosta','Archen','Archeops','Ferrothorn','Klink','Klang','Klinklang','Accelgor','Stunfisk','Pawniard','Bisharp','Durant','Cobalion','Terrakion','Landorus','Bunnelby','Diggersby','Binacle','Barbaracle','Helioptile','Heliolisk','Tyrunt','Tyrantrum','Amaura','Aurorus','Carbink','Zygarde','Diancie','Volcanion','Yungoos','Gumshoos','Mudbray','Mudsdale','Sandygast','Palossand','Type: Null','Silvally','Minior','Jangmo-o','Hakamo-o','Kommo-o','Nihilego','Stakataka']
        if self.name == 'TM39 Rock Tomb':
            return ['Icy_Gigalith','Charmander','Charmeleon','Charizard','Squirtle','Wartortle','Blastoise','Ekans','Arbok','Sandshrew','Sandslash','Nidoqueen','Nidoking','Diglett','Alolan_Diglett','Dugtrio','Alolan_Dugtrio','Mankey','Primeape','Poliwrath','Machop','Machoke','Machamp','Geodude','Alolan_Geodude','Graveler','Alolan_Graveler','Golem','Alolan_Golem','Grimer','Alolan_Grimer','Muk','Alolan_Muk','Onix','Krabby','Kingler','Cubone','Marowak','Alolan_Marowak','Hitmonlee','Hitmonchan','Lickitung','Rhyhorn','Rhydon','Chansey','Kangaskhan','Pinsir','Tauros','Omanyte','Omastar','Kabuto','Kabutops','Aerodactyl','Snorlax','Dragonite','Mewtwo','Mew','Typhlosion','Totodile','Croconaw','Feraligatr','Sudowoodo','Quagsire','Pineco','Forretress','Dunsparce','Gligar','Steelix','Granbull','Shuckle','Heracross','Teddiursa','Ursaring','Slugma','Magcargo','Swinub','Piloswine','Corsola','Mantine','Skarmory','Phanpy','Donphan','Miltank','Blissey','Larvitar','Pupitar','Tyranitar','Treecko','Grovyle','Sceptile','Torchic','Combusken','Blaziken','Mudkip','Marshtomp','Swampert','Nuzleaf','Shiftry','Breloom','Slakoth','Vigoroth','Slaking','Loudred','Exploud','Makuhita','Hariyama','Nosepass','Sableye','Mawile','Aron','Lairon','Aggron','Meditite','Medicham','Sharpedo','Wailmer','Wailord','Numel','Camerupt','Torkoal','Spinda','Trapinch','Vibrava','Flygon','Zangoose','Lunatone','Solrock','Barboach','Whiscash','Corphish','Crawdaunt','Baltoy','Claydol','Lileep','Cradily','Anorith','Armaldo','Kecleon','Dusclops','Absol','Spheal','Sealeo','Walrein','Huntail','Relicanth','Bagon','Shelgon','Salamence','Metang','Metagross','Regirock','Regice','Registeel','Kyogre','Groudon','Rayquaza','Deoxys','Torterra','Monferno','Infernape','Piplup','Prinplup','Empoleon','Cranidos','Rampardos','Shieldon','Bastiodon','Buizel','Floatzel','Gastrodon','Bronzor','Bronzong','Bonsly','Spiritomb','Gible','Gabite','Garchomp','Munchlax','Riolu','Lucario','Hippopotas','Hippowdon','Skorupi','Drapion','Croagunk','Toxicroak','Abomasnow','Lickilicky','Rhyperior','Tangrowth','Electivire','Magmortar','Gliscor','Mamoswine','Gallade','Probopass','Dusknoir','Dialga','Palkia','Heatran','Regigigas','Darkrai','Arceus','Tepig','Pignite','Emboar','Lillipup','Herdier','Stoutland','Pansage','Simisage','Panpour','Simipour','Pansear','Simisear','Munna','Musharna','Roggenrola','Boldore','Gigalith','Drilbur','Excadrill','Timburr','Gurdurr','Conkeldurr','Seismitoad','Throh','Sawk','Scolipede','Sandile','Krokorok','Krookodile','Darumaka','Darmanitan','Dwebble','Crustle','Scraggy','Scrafty','Tirtouga','Carracosta','Archen','Archeops','Gothita','Gothorita','Gothitelle','Solosis','Duosion','Reuniclus','Eelektross','Elgyem','Beheeyem','Axew','Fraxure','Haxorus','Cubchoo','Beartic','Stunfisk','Mienfoo','Mienshao','Druddigon','Golett','Golurk','Pawniard','Bisharp','Bouffalant','Rufflet','Braviary','Vullaby','Mandibuzz','Heatmor','Durant','Hydreigon','Terrakion','Reshiram','Zekrom','Landorus','Kyurem','Chespin','Quilladin','Chesnaught','Froakie','Frogadier','Greninja','Bunnelby','Diggersby','Pancham','Pangoro','Binacle','Barbaracle','Helioptile','Heliolisk','Tyrunt','Tyrantrum','Amaura','Aurorus','Hawlucha','Carbink','Bergmite','Avalugg','Diancie','Yungoos','Gumshoos','Crabrawler','Crabominable','Rockruff','Lycanroc','Mudbray','Mudsdale','Stufful','Bewear','Passimian','Golisopod','Sandygast','Palossand','Minior','Turtonator','Jangmo-o','Hakamo-o','Kommo-o','Tapu Bulu','Solgaleo','Buzzwole','Guzzlord','Necrozma','Marshadow','Stakataka']
        if self.name == 'TM46 Thief':
            return ['Butterfree', 'Beedrill', 'Pidgey', 'Pidgeotto', 'Pidgeot', 'Rattata', 'Alolan_Rattata', 'Raticate', 'Alolan_Raticate', 'Spearow', 'Fearow', 'Ekans', 'Arbok', 'Raichu', 'Alolan_Raichu', 'Sandshrew', 'Alolan_Sandshrew', 'Sandslash', 'Alolan_Sandslash', 'Nidoran_F', 'Nidorina', 'Nidoqueen', 'Nidoran_M', 'Nidorino', 'Nidoking', 'Zubat', 'Golbat', 'Paras', 'Parasect', 'Venonat', 'Venomoth', 'Diglett', 'Alolan_Diglett', 'Dugtrio', 'Alolan_Dugtrio', 'Meowth', 'Alolan_Meowth', 'Persian', 'Alolan_Persian', 'Mankey', 'Primeape', 'Growlithe', 'Arcanine', 'Poliwag', 'Poliwhirl', 'Poliwrath', 'Abra', 'Kadabra', 'Alakazam', 'Machop', 'Machoke', 'Machamp', 'Bellsprout', 'Weepinbell', 'Victreebel', 'Tentacool', 'Tentacruel', "Farfetch'd", 'Doduo', 'Dodrio', 'Seel', 'Dewgong', 'Grimer', 'Alolan_Grimer', 'Muk', 'Alolan_Muk', 'Gastly', 'Haunter', 'Gengar', 'Drowzee', 'Hypno', 'Krabby', 'Kingler', 'Voltorb', 'Electrode', 'Exeggcute', 'Exeggutor', 'Alolan_Exeggutor', 'Cubone', 'Marowak', 'Alolan_Marowak', 'Hitmonlee', 'Hitmonchan', 'Lickitung', 'Koffing', 'Weezing', 'Rhyhorn', 'Rhydon', 'Tangela', 'Kangaskhan', 'Mr. Mime', 'Scyther', 'Jynx', 'Electabuzz', 'Magmar', 'Pinsir', 'Porygon', 'Omanyte', 'Omastar', 'Kabuto', 'Kabutops', 'Aerodactyl', 'Mew', 'Sentret', 'Furret', 'Hoothoot', 'Noctowl', 'Ledyba', 'Ledian', 'Spinarak', 'Ariados', 'Crobat', 'Natu', 'Xatu', 'Sudowoodo', 'Aipom', 'Yanma', 'Quagsire', 'Murkrow', 'Misdreavus', 'Girafarig', 'Dunsparce', 'Gligar', 'Snubbull', 'Granbull', 'Scizor', 'Heracross', 'Sneasel', 'Teddiursa', 'Ursaring', 'Remoraid', 'Octillery', 'Delibird', 'Skarmory', 'Houndour', 'Houndoom', 'Porygon2', 'Stantler', 'Tyrogue', 'Hitmontop', 'Smoochum', 'Elekid', 'Magby', 'Poochyena', 'Mightyena', 'Zigzagoon', 'Linoone', 'Beautifly', 'Dustox', 'Lotad', 'Lombre', 'Ludicolo', 'Nuzleaf', 'Shiftry', 'Taillow', 'Swellow', 'Wingull', 'Pelipper', 'Ralts', 'Kirlia', 'Gardevoir', 'Surskit', 'Masquerain', 'Ninjask', 'Shedinja', 'Sableye', 'Electrike', 'Manectric', 'Volbeat', 'Illumise', 'Carvanha', 'Sharpedo', 'Spoink', 'Grumpig', 'Spinda', 'Swablu', 'Altaria', 'Zangoose', 'Seviper', 'Castform', 'Kecleon', 'Shuppet', 'Banette', 'Duskull', 'Dusclops', 'Absol', 'Starly', 'Staravia', 'Staraptor', 'Bidoof', 'Bibarel', 'Shinx', 'Luxio', 'Luxray', 'Cranidos', 'Rampardos', 'Vespiquen', 'Ambipom', 'Drifloon', 'Drifblim', 'Mismagius', 'Honchkrow', 'Glameow', 'Purugly', 'Stunky', 'Skuntank', 'Bonsly', 'Mime Jr.', 'Chatot', 'Spiritomb', 'Skorupi', 'Drapion', 'Croagunk', 'Toxicroak', 'Carnivine', 'Weavile', 'Lickilicky', 'Rhyperior', 'Tangrowth', 'Electivire', 'Magmortar', 'Yanmega', 'Gliscor', 'Porygon-Z', 'Gallade', 'Dusknoir', 'Rotom', 'Darkrai', 'Purrloin', 'Liepard', 'Pansage', 'Simisage', 'Pansear', 'Simisear', 'Panpour', 'Simipour', 'Woobat', 'Swoobat', 'Whimsicott', 'Sandile', 'Krokorok', 'Krookodile', 'Darumaka', 'Darmanitan', 'Scrafty', 'Sigilyph', 'Yamask', 'Cofagrigus', 'Trubbish', 'Garbodor', 'Zorua', 'Zoroark', 'Minccino', 'Cinccino', 'Gothita', 'Gothorita', 'Gothitelle', 'Joltik', 'Galvantula', 'Elgyem', 'Beheeyem', 'Litwick', 'Lampent', 'Chandelure', 'Golett', 'Golurk', 'Pawniard', 'Bisharp', 'Vullaby', 'Mandibuzz', 'Heatmor', 'Deino', 'Zweilous', 'Hydreigon', 'Tornadus', 'Thundurus', 'Fennekin', 'Braixen', 'Delphox', 'Froakie', 'Frogadier', 'Greninja', 'Bunnelby', 'Diggersby', 'Fletchling', 'Fletchinder', 'Talonflame', 'Vivillon', 'Litleo', 'Pyroar', 'Pangoro', 'Swirlix', 'Slurpuff', 'Inkay', 'Malamar', 'Binacle', 'Barbaracle', 'Dedenne', 'Klefki', 'Phantump', 'Trevenant', 'Pumpkaboo', 'Gourgeist', 'Noibat', 'Noivern', 'Yveltal', 'Hoopa', 'Pikipek', 'Trumbeak', 'Toucannon', 'Yungoos', 'Gumshoos', 'Crabrawler', 'Crabominable', 'Cutiefly', 'Ribombee', 'Salandit', 'Salazzle', 'Comfey', 'Passimian', 'Komala', 'Togedemaru', 'Mimikyu', 'Dhelmise', 'Tapu Koko', 'Tapu Lele', 'Guzzlord', 'Necrozma', 'Marshadow', 'Naganadel', 'Blacephalon']
        if self.name == 'TM49 Echoed Voice':
            return ['Spooky_Wobbuffet','Bulbasaur', 'Ivysaur', 'Venusaur', 'Charmander', 'Charmeleon', 'Charizard', 'Spearow', 'Fearow', 'Pikachu', 'Raichu', 'Alolan_Raichu', 'Nidoran_F', 'Nidorina', 'Nidoqueen', 'Nidoran_M', 'Nidorino', 'Nidoking', 'Clefairy', 'Clefable', 'Jigglypuff', 'Wigglytuff', 'Diglett', 'Alolan_Diglett', 'Dugtrio', 'Alolan_Dugtrio', 'Meowth', 'Alolan_Meowth', 'Persian', 'Alolan_Persian', 'Alolan_Golem', 'Ponyta', 'Rapidash', 'Slowpoke', 'Slowbro', 'Doduo', 'Dodrio', 'Seel', 'Dewgong', 'Cubone', 'Marowak', 'Alolan_Marowak', 'Chansey', 'Jynx', 'Lapras', 'Eevee', 'Vaporeon', 'Jolteon', 'Flareon', 'Mew', 'Chikorita', 'Bayleef', 'Meganium', 'Sentret', 'Furret', 'Hoothoot', 'Noctowl', 'Pichu', 'Cleffa', 'Igglybuff', 'Togepi', 'Togetic', 'Mareep', 'Flaaffy', 'Ampharos', 'Espeon', 'Umbreon', 'Slowking', 'Misdreavus', 'Girafarig', 'Phanpy', 'Donphan', 'Smoochum', 'Miltank', 'Blissey', 'Lugia', 'Ho-Oh', 'Celebi', 'Torchic', 'Combusken', 'Blaziken', 'Mudkip', 'Marshtomp', 'Swampert', 'Zigzagoon', 'Linoone', 'Lotad', 'Lombre', 'Ludicolo', 'Taillow', 'Swellow', 'Wingull', 'Pelipper', 'Ralts', 'Kirlia', 'Gardevoir', 'Whismur', 'Loudred', 'Exploud', 'Skitty', 'Delcatty', 'Plusle', 'Minun', 'Wailmer', 'Wailord', 'Numel', 'Camerupt', 'Swablu', 'Altaria', 'Chimecho', 'Absol', 'Spheal', 'Sealeo', 'Walrein', 'Rayquaza', 'Piplup', 'Prinplup', 'Empoleon', 'Starly', 'Staravia', 'Staraptor', 'Bidoof', 'Bibarel', 'Kricketune', 'Pachirisu', 'Buizel', 'Floatzel', 'Mismagius', 'Glameow', 'Purugly', 'Chingling', 'Happiny', 'Chatot', 'Togekiss', 'Leafeon', 'Glaceon', 'Gallade', 'Dialga', 'Palkia', 'Giratina', 'Arceus', 'Tepig', 'Pignite', 'Emboar', 'Purrloin', 'Liepard', 'Pidove', 'Tranquill', 'Unfezant', 'Audino', 'Tympole', 'Palpitoad', 'Seismitoad', 'Minccino', 'Cinccino', 'Deerling', 'Sawsbuck', 'Elgyem', 'Beheeyem', 'Cubchoo', 'Beartic', 'Hydreigon', 'Reshiram', 'Zekrom', 'Kyurem', 'Meloetta', 'Fennekin', 'Braixen', 'Delphox', 'Froakie', 'Frogadier', 'Greninja', 'Litleo', 'Pyroar', 'Flabebe', 'Floette', 'Floette', 'Florges', 'Pancham', 'Pangoro', 'Furfrou', 'Espurr', 'Meowstic', 'Spritzee', 'Aromatisse', 'Amaura', 'Aurorus', 'Sylveon', 'Noibat', 'Noivern', 'Xerneas', 'Rowlet', 'Dartrix', 'Decidueye', 'Popplio', 'Brionne', 'Primarina', 'Pikipek', 'Trumbeak', 'Toucannon', 'Yungoos', 'Gumshoos', 'Rockruff', 'Lycanroc', 'Lycanroc', 'Lycanroc', 'Comfey', 'Drampa', 'Jangmo-o', 'Hakamo-o', 'Kommo-o', 'Tapu Koko', 'Tapu Lele', 'Tapu Bulu', 'Tapu Fini', 'Nihilego', 'Pheromosa', 'Magearna', 'Marshadow', 'Poipole', 'Naganadel', 'Zeraora']
        if self.name == 'TM54 False Swipe':
            return ['Beedrill', 'Spearow', 'Fearow', 'Sandshrew', 'Sandslash', 'Alolan_Sandslash', 'Paras', 'Parasect', 'Meowth', 'Persian', "Farfetch'd", 'Krabby', 'Kingler', 'Cubone', 'Marowak', 'Alolan_Marowak', 'Scyther', 'Pinsir', 'Mew', 'Gligar', 'Scizor', 'Heracross', 'Sneasel', 'Grovyle', 'Sceptile', 'Seedot', 'Nuzleaf', 'Shiftry', 'Shroomish', 'Breloom', 'Slakoth', 'Vigoroth', 'Slaking', 'Nincada', 'Ninjask', 'Shedinja', 'Mawile', 'Zangoose', 'Corphish', 'Crawdaunt', 'Anorith', 'Armaldo', 'Absol', 'Kricketune', 'Gible', 'Gabite', 'Garchomp', 'Skorupi', 'Drapion', 'Weavile', 'Gliscor', 'Gallade', 'Oshawott', 'Dewott', 'Samurott', 'Leavanny', 'Karrablast', 'Escavalier', 'Axew', 'Fraxure', 'Haxorus', 'Pawniard', 'Bisharp', 'Cobalion', 'Terrakion', 'Virizion', 'Keldeo', 'Pancham', 'Pangoro', 'Honedge', 'Doublade', 'Aegislash', 'Binacle', 'Barbaracle', 'Hawlucha', 'Rowlet', 'Dartrix', 'Decidueye', 'Fomantis', 'Lurantis', 'Golisopod', 'Jangmo-o', 'Hakamo-o', 'Kommo-o', 'Tapu Koko', 'Tapu Bulu', 'Buzzwole', 'Pheromosa', 'Kartana', 'Magearna', 'Marshadow', 'Zeraora']
        ...
        if self.name == 'TM99 Dazzling Gleam':
            return ['Spooky_Wobbuffet','Clefairy', 'Clefable', 'Alolan_Ninetales', 'Jigglypuff', 'Wigglytuff', 'Oddish', 'Gloom', 'Vileplume', 'Abra', 'Kadabra', 'Alakazam', 'Tentacool', 'Tentacruel', 'Gastly', 'Haunter', 'Gengar', 'Drowzee', 'Hypno', 'Chansey', 'Staryu', 'Starmie', 'Mr. Mime', 'Mew', 'Chinchou', 'Lanturn', 'Togepi', 'Togetic', 'Natu', 'Xatu', 'Bellossom', 'Hoppip', 'Skiploom', 'Jumpluff', 'Espeon', 'Misdreavus', 'Girafarig', 'Snubbull', 'Granbull', 'Blissey', 'Celebi', 'Ralts', 'Kirlia', 'Gardevoir', 'Nosepass', 'Sableye', 'Volbeat', 'Illumise', 'Roselia', 'Swablu', 'Altaria', 'Baltoy', 'Claydol', 'Shuppet', 'Banette', 'Chimecho', 'Jirachi', 'Budew', 'Roserade', 'Cherubi', 'Cherrim', 'Mismagius', 'Chingling', 'Togekiss', 'Gallade', 'Probopass', 'Uxie', 'Mesprit', 'Azelf', 'Phione', 'Manaphy', 'Shaymin', 'Victini', 'Munna', 'Musharna', 'Audino', 'Cottonee', 'Whimsicott', 'Sigilyph', 'Minccino', 'Cinccino', 'Frillish', 'Jellicent', 'Meloetta', 'Delphox', 'Flabebe', 'Floette', 'Floette', 'Florges', 'Spritzee', 'Aromatisse', 'Swirlix', 'Slurpuff', 'Sylveon', 'Carbink', 'Klefki', 'Xerneas', 'Diancie', 'Primarina', 'Cutiefly', 'Ribombee', 'Morelull', 'Shiinotic', 'Bounsweet', 'Steenee', 'Tsareena', 'Comfey', 'Minior', 'Mimikyu', 'Tapu Koko', 'Tapu Lele', 'Tapu Bulu', 'Tapu Fini', 'Lunala', 'Nihilego', 'Xurkitree', 'Magearna']
        if self.name == 'TM100 Confide':
            return ['Reverse','Caterpie','Metapod','Weedle','Kakuna','Magikarp','Ditto','Unown','Wobbuffet','Smeargle','Wurmple','Silcoon','Cascoon','Wynaut','Beldum','Kricketot','Combee','Tynamo','Scatterbug','Spewpa','Cosmog','Cosmoem','Guzzlord','Stakataka']
    ...
    def use_spe(self,P):
        ...
        back = poke_func.load("p/ui/load_back.png")
            ...
            for p in P.party:
                ...
                if self.type[1] == 'TM':
                    ...
                    if poke_func.has_shiny(p):
                        ...
                        P.surface.blit(notable,(x+150,y+70))
                elif self.type[0] == 'Ability Capsule':
                    if len(p.ability_list()[0]) == 2:
                        P.surface.blit(able,(x+150,y+70))
                    else:
                        P.surface.blit(notable,(x+150,y+70))
                ...
                if event.key == pygame.key.key_code(P.controls[5]) and a > 10:
                    ...
                    if self.type[1] == 'TM':
                        ...
                        if self.can_hs(P.party[current]):
                            ...
                            a = 1
                    elif self.type[0] == 'Ability Capsule' and len(P.party[current].ability_list()[0]) == 2:
                        new_abi = P.party[current].switch_ability()
                        poke_func.txt(P,P.party[current].name+" changed abilities to "+new_abi+"!")
                        ...
                        if P.party[current].evo != [] and P.party[current].evo[0] == self.name:
                            ...
                            poke_func.add_item(P,self.name,-1)
                            return
                        elif P.party[current].code_nos() == 'Snorunt' and self.name == 'Dawn Stone' and P.party[current].gen == 1:
                            song = P.song
                            poke_func.fade_out(P,P.song)
                            copy = P.party[current].copy()
                            copy.evo[2] = 'Ominous Wind'
    ...
    def use_item(self,P,battle = False):
        ...
        while end:
            ...
            for p in P.party:
                ...
                if p.status != None:
                    status = poke_func.load("p/ui/"+p.status+"_ico.png")
                    ...
                    if self.type[0] == 'Potion' and P.party[current].ch < P.party[current].hp and P.party[current].status != 'Faint':
                        ...
                        if self.name == 'Expired Candy':
                            ...
                            if P.party[current].status != None:
                                status = poke_func.load("p/ui/"+P.party[current].status+"_ico.png")
                                status = pygame.transform.scale(status,(50,20))
                                P.surface.blit(status,(x+145,y+95))
    ...
    def battle_menu(self,P,num) -> str:
        ...
        if self.type[0] == 'Ball' or self.type[0] == 'Potion' or self.type[0] == 'Battle Berry':
            tbox = poke_func.load("p/ui/2_box.png")
            options.append(cancel)
            options.append(use)
            boxy = 330
        else:
            tbox = poke_func.load("p/ui/1_box.png")
            options.append(cancel)
            boxy = 380
    ...
    def menu(self,P,num) -> bool:
        ...
        if self.type[0] in ['Held','Gem','Ball'] or self.name == 'Persim Berry':
            tbox = poke_func.load("p/ui/3_box.png")
            options.append(cancel)
            options.append(toss)
            options.append(give)
            boxy = 280
            ...
            options.append(use)
            boxy = 330
        elif self.type[0] in ['Ability Capsule','Evo','Food','Heart Scale','Balm Mushroom','Candy','Potion','Petal'] or (self.type[0] == 'Battle Berry' and self.name != 'Persim Berry'):
            tbox = poke_func.load("p/ui/4_box.png")
            options.append(cancel)
            options.append(toss)
            options.append(give)
            options.append(use)
                    ...
                    if options[ans] == use:
                        if self.type[1] == 'TM':
                            ...
                            if self.name == 'Map':
                                ...
                                return True
                            elif self.name == 'PokeStar Tablet':
                                P.use_key_item = None
                                poke_func.fade_out(P)
                                poke_func.pokestar(P)
                                return True
                            end = False
                        elif self.type[0] in ['Ability Capsule','Heart Scale','Evo','Balm Mushroom','Petal']:
                            poke_func.fade_out(P)
                            self.use_spe(P)
                            return True
                        else:
